...
class qrcode{
	...
	function contact_info($name, $address, $phone, $email){
	...
	function content($type, $size, $content){
		$this->data = "CNTS:TYPE:".$type.";LNG:".$size.";BODY:".$content.";;";
	}
	
	//getting image
	function get_image($size = 150, $EC_level = 'L', $margin = '0'){
		$ch = curl_init();
	...
	function get_link($size = 150, $EC_level = 'L', $margin = '0'){
		$this->data = urlencode($this->data); 
