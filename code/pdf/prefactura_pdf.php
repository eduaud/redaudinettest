...
class PDF extends FPDF{
	function Header(){
			...
			$this -> Cell(65,5,"PREFACTURA",'LRT',1,'C',1);
			...
			$this -> Cell(130,5,$rfc_compania,0,1,'L',0);
	...
	foreach($producto as $datos){
		...
		$this->MultiCell(119,5,$datosProducto -> nombre,'R',';L');
		...
		$this->MultiCell(119,5,'          '.$contratos,'R','L');
