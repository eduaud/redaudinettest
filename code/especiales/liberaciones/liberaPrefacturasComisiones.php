...
$queryTipoCliente = 'SELECT id_tipo_cliente_proveedor, nombre FROM cl_tipos_cliente_proveedor WHERE activo="1" AND id_tipo_cliente_proveedor IN (1,2,3) 
...
$smarty -> display("especiales/liberaciones/liberaPrefacturasComisiones.tpl");
?>