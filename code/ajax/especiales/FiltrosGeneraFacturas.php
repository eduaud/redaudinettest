...
if(isset($filtros)){
  ...
  if($filtros ==1 && $accion=1){
	...
	{
		if($strWhere =='')
		   $strWhere.= " a.fecha_y_hora >= '".convertDate($fecdel)." 00:00:00'";
		else   
		   $strWhere.= $Orden." a.fecha_y_hora >= '".convertDate($fecdel)." 00:00:00'";
	}
	if($fecal != '')	  
	{
	   if($strWhere =='')
		$strWhere.= " a.fecha_y_hora <= '".convertDate($fecal)." 24:59:59'";
	   else
	    $strWhere.= $Orden." a.fecha_y_hora <= '".convertDate($fecal)." 24:59:59'";	
	}
