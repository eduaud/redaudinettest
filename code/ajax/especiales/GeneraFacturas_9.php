...
GROUP BY a.id_cliente";    
	...
	if($num >0){
	   ...
	   $strInsert = "INSERT INTO anderp_facturas (id_control_factura,".$strCamposNombre.",fecha_y_hora,activo,notas_venta_asociadas,id_cliente) VALUES (NULL,".$strValores.",NOW(),1,'".$NVAsociadas."',1)";
	   //echo $strInsert."\n";
...
WHERE a.id_sucursal=".$IDSucursal." AND a.id_control_nota_venta=".$notasVenta[$i];    
	...
	if($num >0){
	   ...
	   $strInsert = "INSERT INTO anderp_facturas (id_control_factura,".$strCamposNombre.",fecha_y_hora,activo,notas_venta_asociadas) VALUES (NULL,".$strValores.",NOW(),1,".$notasVenta[$i].")";
	   //echo $strInsert."\n";
...
GROUP BY a.id_cliente";  
	...
	if($num >0){
	  ...
	  if($opcionCli == 1){ //cliente requiere Factura
	      $strInsert = "INSERT INTO anderp_facturas (id_control_factura,".$strCamposNombre.",fecha_y_hora,activo,notas_venta_asociadas) VALUES (NULL,".$strValores.",NOW(),1,'".$NVAsociadas."')";
	  }
	  else{
