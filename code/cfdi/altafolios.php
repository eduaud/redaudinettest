...
//CONECCION Y PERMISOS A LA BASE DE DATOS
	...
	else if($opcion==2)  //para alta de folios 
	{
		$strConsulta="SELECT 
							id_serie, 
							nombre 
					...
					AND id_serie IN (
									...
									WHERE id_tipo_documento='".$documento."' AND anderp_series_documentos.activo=1) AND anderp_series.id_sucursal =".$_SESSION["USR"]->sucursalid;
	...
	else if($opcion==3)  //coloca en GRID  Ultimos Folios por Documento
	{
		/*$strConsulta="SELECT 
