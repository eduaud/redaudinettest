...
{literal}
	function buscaPedido(){
				...
				if(pedido == ""){
						alert("Anota un numero de pedido");
						}
				else{
						$(".cuerpo-pedidos tbody tr").remove();
						var ruta = "llenaTablaPedidos.php";
...
<body>
		<h1> B&uacute;squeda de Pedidos </h1>
<div id="busquedas">
<p>Buscar por:</p><br>
		...
		<div id="pedido" style="float:left; padding-left:25px;">
				<label for="busca_pedido">Pedido</label><input type="text" id="busca_pedido" name="busca_pedido" class="busca-producto"/>
				<br>
...
<div style="margin:20px 0; width:100%">
		...
		<div id="scroll-tabla">
				<table border="0" class="cuerpo-pedidos"> 
						<tbody>
						</tbody>
				</table>
		</div>
</div>
<p style="display:block; float:right;"><input type="button" class="boton" value="A&ntilde;adir Pedidos &raquo;" onClick="anadirPedido();"/></p>
<br />
</body>
</html>