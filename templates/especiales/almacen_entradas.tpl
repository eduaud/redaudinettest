{if $tipoPantalla eq "1"}
    ...
    <script language="JavaScript" type="text/javascript" src="{$rooturl}js/almacen_entradas.js"></script>
    {literal}
    	<style>
			td{
				font-size:12px;
...
<div style="padding-top:20px; padding-bottom:20px">
	<div class="m_modificar_catalogo m_modificar_catalogo">
		...
		<table width="935" border="0" cellpadding="0" cellspacing="0" id="form">
			<tr>
				...
				<td>
					...
					<select name="c_categorias" class="select_filtro" id="tipoEntrada">
                        <option value="0" selected="selected"> - Seleccione tipo de entrada - </option>
			...
			<tr>
				...
				<td>
					<span class="camporequerido">
					<input name="textfield41" type="text" class="inputfield" id="idDocBuscado" size="25" value="32264" />
					*</span>
				</td>
				<td width="173" class="form_labels">&nbsp;</td>
				<td width="303">&nbsp;</td>
			...
			<tr>
				...
				<td width="231"><input type="button" name="modificar" id="buscarDatos" value=" Buscar &raquo;" class="botonSecundario">	</td>
				<td width="173" class="form_labels">&nbsp;</td>
				<td width="303">&nbsp;</td>
			</tr>
		</table>
    ...
    <div class="m_modificar_catalogo m_modificar_catalogo" id="contenido" style="display:none">
		...
		<table border="0" cellpadding="0" cellspacing="0" id="table_cat_cia">
			<tr>
				<th width="100" scope="col"><p>Producto</p></th>
				<th width="350" scope="col"><p>Ubicaci&oacute;n</p></th>
				<th width="200" scope="col"><p>Cantidad recibida</p></th>
				<th width="150" scope="col"><p>Lote</p></th>
				<th width="150" scope="col"><p>Documento</p></th>
...
<script language="JavaScript" type="text/javascript" src="{$rooturl}js/almacen_entradasPop.js"></script>
...
{if $esLlanta eq "1" or $tipoDocumento neq "1"}
