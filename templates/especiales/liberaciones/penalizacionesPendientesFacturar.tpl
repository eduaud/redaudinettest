...
<link href="{$rooturl}css/jquery-ui.css" rel="stylesheet" type="text/css"> -->
 ...
 <br>
<h1>Penalizaciones Pendientes por Facturar</h1> </div>
...
{literal}
	<script language="javascript">
		...
		function facturarPenalizaciones(){
			$("#waitingplease").show();
			...
			if(seleccion.length > 0){
				var conf = confirm("Desea facturar las penalizaciones?");
				if(conf){
					var seleccionJSON = JSON.stringify(seleccion);
				
					var datos="seleccion=" + seleccionJSON + "&tipo2=penalizaciones";
					...
					$.ajax({
						...
						success: function(data){
							...
							location.href="../../indices/listados.php?t=YWRfZmFjdHVyYXNfYXVkaWNlbA==";
						},
						timeout:50000
					});
				}
...
<table align="right"><tr><td><input class="boton" type="button" onclick="facturarPenalizaciones();" value="Facturar Penalizaciones"></td></tr></table>
