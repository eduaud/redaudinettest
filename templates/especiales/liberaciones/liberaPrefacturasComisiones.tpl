...
<link href="{$rooturl}css/jquery-ui.css" rel="stylesheet" type="text/css"> -->
 ...
 <br>
<h1>Liberaci&oacute;n de Comisiones Pendientes por Facturar</h1> </div>
...
{literal}
	<script language="javascript">
		...
		function listaResultadoDeBusqueda(){
			...
			var datos="plazas=" + plazas + "&tiposCliente=" + tiposCliente + "&clientes=" + clientes + "&fechaIni=" + fechaIni + "&fechaFin=" + fechaFin + "&clave=" + clave + "&id_accion_contrato=21";
		...
		function liberarComisiones(){
			...
			if(comisiones.length > 0){
				var datos="comisiones=" + comisionesJSON;
				...
				$.ajax({
					...
					contentType: "application/x-www-form-urlencoded",
					data: datos,
					url: "../../ajax/liberarComisionesPendientesFacturar.php",
					success: function(data) {
						$("#waitingplease").hide();
						alert("Las comisiones han sido liberadas correctamente");
...
<table align="right"><tr><td><input class="boton" type="button" onclick="liberarComisiones();" value="Liberar Comisiones Pendientes"></td></tr></table>
