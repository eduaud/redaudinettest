...
<link href="{$rooturl}css/jquery-ui.css" rel="stylesheet" type="text/css"> -->
 ...
 <br>
<h1>Liberaci&oacute;n de Bonos por Plaza</h1> </div>
	...
	<script language="javascript">
		...
		function liberar(){
			...
			if(comisiones.length > 0){
				...
				var datos="comisiones=" + comisionesJSON + "&tipo2=bonos";
				...
				$.ajax({
					...
					success: function(data) {
						$("#waitingplease").hide();
						alert("Los bonos se liberaron correctamente.");
...
<table align="right"><tr><td><input class="boton" type="button" onclick="liberar();" value="Liberar"></td></tr></table>
