...
<table>
	...
	<tr>
		<td>Estatus de Pedido: </td>
		<td><select name="sucursal"> <option value="0"> -- Estatus de Pedido -- </option></select></td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		<td>&nbsp;</td>
	...
	<tr>
		<td>Estatus de Pago de Pedido: </td>
		<td><select name="sucursal"> <option value="0"> -- Estatus de Pago de Pedido-- </option></select></td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		<td>&nbsp;</td>
	...
	<tr>
		<td>Cliente: </td>
		<td><select name="sucursal"> <option value="0"> -- Selecciona un Cliente -- </option></select></td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		<td>&nbsp;</td>
	...
	<tr>
		...
		<td><select name="sucursal"> <option value="0"> -- Selecciona un dirección de entrega -- </option></select></td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		<td>&nbsp;</td>
	...
	<tr>
		<td>Vendedor: </td>
		<td><select name="sucursal"> <option value="0"> -- Selecciona un Vendedor -- </option></select></td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		<td>&nbsp;</td>
	...
	<tr>
		<td>Usuario: </td>
		<td><select name="sucursal"> <option value="0"> -- Selecciona un usuario -- </option></select></td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		<td>&nbsp;</td>
	...
	<tr>
		<td>Tipo de Pago: </td>
		<td><select name="sucursal"> <option value="0"> -- Selecciona un tipo de pago -- </option></select></td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		<td>&nbsp;</td>
	...
	<tr>
		<td>Cobra Flete: </td>
		<td><input type="checkbox" name="flete"></td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		<td>&nbsp;</td>
	...
	<tr>
		<td>Descuento solicitado: </td>
		<td><input type="date" name="descuento"></td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		<td>&nbsp;</td>
	...
	<tr>
		<td>Usuario Aprobo: </td>
		<td><input type="checkbox" name="aprobo"></td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		<td>&nbsp;</td>
	...
	<tr>
		...
		<td><input type="checkbox" name="factura"></td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		<td>&nbsp;</td>
	...
	<tr>
		...
		<td><select name="sucursal"> <option value="0"> -- Selecciona información fiscal -- </option></select></td>
	</tr>
		<tr>
		<td>&nbsp;</td>
		<td>&nbsp;</td>
	...
	<tr>
		<td>Subtotal: </td>
		<td><input type="text" name="flete"></td>
	</tr>
		<tr>
		<td>&nbsp;</td>
		<td>&nbsp;</td>
  ...
  <table>
		<tr>
			<td width="1000">
				...
				<tr class="HeaderCell">                      
					<td tipo="texto" modificable="N" mascara="" align="left" formula="" depende="" onChange="" largo_combo="0" verSumatoria="" valida="" onkey="" inicial="" width="200" offsetwidth="130" on_Click="">Producto</td>
					<td tipo="texto" modificable="N" mascara="" align="left" formula="" depende="" onChange="" largo_combo="0" verSumatoria="" valida="" onkey="" inicial="" width="120" offsetwidth="150" on_Click="">Cantidad solicitada</td>
					<td tipo="texto" modificable="N" mascara="" align="left" formula=""  depende="" onChange="" largo_combo="0" verSumatoria="" valida="" onkey="" inicial="" width="75" offsetwidth="75" on_Click="">Existencia</td>
					<td tipo="texto" modificable="N" mascara="" align="left" formula=""  depende="" onChange="" largo_combo="0" verSumatoria="" valida="" onkey="" inicial="" width="150" offsetwidth="200" on_Click="">Pendiente por entregar</td>                     	
					<td tipo="texto" modificable="N" mascara="" align="left" formula=""  depende="" onChange="" largo_combo="0" verSumatoria="" valida="" onkey="" inicial="" width="120" offsetwidth="200" on_Click="">Cantidad a surtir</td>                     	
					<td tipo="texto" modificable="N" mascara="" align="left" formula=""  depende="" onChange="" largo_combo="0" verSumatoria="" valida="" onkey="" inicial="" width="120" offsetwidth="200" on_Click="">Lista de Precios</td>   
