...
<table border="0" class="tableFormCuentasContables">
				<tbody>
						...
						<tr>
							...
							<td>
								<select id="cuentaSAT" name="cuentaSAT">
										...
										{section name="CuentaSAT" loop=$aCuentaSAT}
											<option value="{$aCuentaSAT[CuentaSAT].0}" disabled="disabled" selected>{$aCuentaSAT[CuentaSAT].2}</option>
										{/section}
								</select>
							</td>
						</tr>
						<tr>
							...
							<td>
								<input type="text" name="es_cuenta_mayor" id="es_cuenta_mayor" size="5" readonly {if $datosCuenta[detalleCuenta].3 == 1} value="SI" {else} value="NO" {/if} />
							</td>
							<td>
								¿Es Facturable? 
							</td>
						...
						<tr>
							...
							<td align="right">
								...
								<a style="text-decoration: none" id="frmEditarCuentaContable" data-fancybox-type="iframe" onClick="editarCuentaContable('{$datosCuenta[detalleCuenta].0}',{$datosCuenta[detalleCuenta].3})">
									<input name="btnEditarCuentaContable" class="botonSecundario" type="button" value=" Editar »" />
								</a>
							...
							<td align="right">
								<input class="botonSecundario" type="button" onclick="eliminarCuentaContable('{$datosCuenta[detalleCuenta].0}','{$datosCuenta[detalleCuenta].1}',{$datosCuenta[detalleCuenta].3})" value=" Eliminar »" />
							</td>
						</tr>
				</tbody>
		</table>
