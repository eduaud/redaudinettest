...
{literal}
		function buscaOrden(){
				...
				if(orden == ""){
						...
						var ruta = "llenaTablaOrdenesRecoleccion.php";
		...
		function verOrdenCompra(idOrden){
				window.open(
				"../../code/general/encabezados.php?t=bmFfb3JkZW5lc19yZWNvbGVjY2lvbl9jbGllbnRlcw==&k=" + idOrden + "&op=2&v=1", "_blank");
		...
		function apruebaOrden(pos){
				...
				var confirma=confirm("Esta seguro de querer aprobar esta orden de recoleccion?");
						if(confirma==true){
								...
								var url = "apruebaRechazoOrdenRecoleccion.php";
...
<h1 class="encabezado">Aprobaci&oacute;n de Ordenes de Recolecci&oacute;n</h1>
<div id="busquedas">
<p>Buscar por:</p><br>
		...
		<div id="orden-compra" style="float:left; padding-left:25px;">
				<label for="orden">Orden de Recolecci&oacute;n</label><input type="text" id="orden" name="orden" class="busca-orden"/>
				<br><br>
		...
		<caption>Ordenes de Recoleccion a Clientes</caption>
				<thead>
						<tr>
								...
								<th style="width:80px;">Orden de Recolecci&oacute;n</th>
						...
						{assign var="contador" value="1"}
								{section name="filasOrdenes" loop=$filas}
										<tr>
												...
												<td style="width:100px; text-align:center">{$filas[filasOrdenes].0}</td>
												<td style="width:100px; text-align:center">{$filas[filasOrdenes].1}</td>
												<td style="width:200px; text-align:center">{$filas[filasOrdenes].2}</td>
												<td style="width:150px; text-align:center">{$filas[filasOrdenes].3}</td>
												...
												<div style="width : auto">
														...
														<input type="button" id="rechazar" class="botonesD" style="width:40px" value="Ver" onClick="verOrdenCompra({$filas[filasOrdenes].0})"/><br><br>
														<textarea style="width:150px" id="motivo-rechazo{$contador}" class="rechazo"></textarea>
												</div>		
												
												</td>
												<td style="display:none"><input id="idOrden{$contador}" type="hidden" value="{$filas[filasOrdenes].0}"/></td>
