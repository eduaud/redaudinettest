...
// ------------------------------------------------------------------------------------------------
	function _convert($token) {
		...
		else if(preg_match("/[A-Z0-9À-&uuml;\.]+/",$token)) {
	...
	function _match($token) {
		switch($token) {
			...
			default:
				...
				// function call
				//elseif(eregi("^[A-Z0-9À-&uuml;\.]+$",$token) && ($this->_next == "(")) {
				else if(preg_match("/^[A-Z0-9À-&uuml;\.]+$/i",$token) && ($this->_next == "(")) {
					return $token;
				}
...
// ------------------------------------------------------------------------------------------------
	function _factor() {
		...
		//elseif (eregi("^[A-Z0-9À-&uuml;\.]+$",$this->_current_token)) {
		else if (preg_match("/^[A-Z0-9À-&uuml;\.]+$/i",$this->_current_token)) { // function call
